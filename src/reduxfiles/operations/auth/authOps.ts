...
export const userAuth = createAsyncThunk<AuthPayloadType, authDataType, { rejectValue: string }>(
	"user/Auth",
...
export const getCurrentUser = createAsyncThunk<AuthPayloadType, undefined, { rejectValue: string; state: RootState }>(
	"user/GetCurrent",
